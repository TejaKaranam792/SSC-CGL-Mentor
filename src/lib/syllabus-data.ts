...
const RAW_DATA: SyllabusTopic[] = [
  ...
  { id: 'speed_distance', subject: 'Quant', topicLabel: 'Speed & Distance', avgQuestions: '2-3', weightage: 8, scoringEase: 6, timeRequired: 7, isTrap: false, description: 'Crucial for Tier 2. Includes Trains, Boats & Streams, and Relative Speed concepts.' },
