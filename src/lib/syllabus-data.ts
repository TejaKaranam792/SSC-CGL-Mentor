...
const RAW_DATA: SyllabusTopic[] = [
  ...
  { id: 'profit_loss', subject: 'Quant', topicLabel: 'Profit & Loss', avgQuestions: '2-3', weightage: 8, scoringEase: 7, timeRequired: 5, isTrap: false, description: 'Directly linked to Percentage. High scoring potential once the core logic of CP/SP is understood.' },
  ...
  { id: 'speed_distance', subject: 'Quant', topicLabel: 'Time, Speed & Distance', avgQuestions: '2-3', weightage: 8, scoringEase: 6, timeRequired: 7, isTrap: false, description: 'Crucial for Tier 2. Includes Trains, Boats & Streams, and Relative Speed concepts.' },
